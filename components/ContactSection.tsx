      ...
      <div className="flex flex-col lg:w-9/12">
        ...
        <div className="flex flex-col gap-4 w-full lg:w-4/12">
          <Link href={SOCIAL_LINKS.instagram} target="_blank">
            <div className="flex items-center p-4 rounded-xl bg-secondary transition border border-highlight hover:border-accent-secondary hover:text-accent-secondary">
